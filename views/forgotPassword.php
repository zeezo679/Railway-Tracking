                ...
                <div class="card-body p-5">
                  ...
                  <form method="POST" action="/forgotPass">
                    ...
                    <div data-mdb-input-init class="form-outline justify-content-between align-items-center d-flex mb-4">
                      <label class="form-label fw-700 w-25 " for="form3Example1cg">Email</label>
                       
                      <input name="email" type="text" placeholder="Enter First Name" id="form3Example1cg" class="form-control w-75 form-control-lg" />
                    </div>

                    <div class="d-flex justify-content-center">
                      <button  type="submit" data-mdb-button-init
                        data-mdb-ripple-init class="btn btn-success btn-block btn-lg gradient-custom-4 text-light">Submit</button>
                    </div>
                    <?php if (!empty($errors)): ?>
