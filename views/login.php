      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
          <form method="POST" action="/login">
            ...
            <div data-mdb-input-init class="form-outline mb-4 d-flex align-items-center gap-3">
              ...
              <input required name="email" type="email" id="form3Example3" class="w-75 form-control form-control-lg"
            ...
            <div data-mdb-input-init class="d-flex align-items-center gap-3 form-outline mb-3">
              ...
              <input required name="password" type="password" id="form3Example4" class="w-75 form-control form-control-lg"
